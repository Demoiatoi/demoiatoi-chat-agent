...
.avatar-wrap{width:42px;height:42px;border-radius:50%;background:rgba(255,255,255,.25);display:flex;align-items:center;justify-content:center;font-size:23px;border:2px solid rgba(255,255,255,.4);flex-shrink:0;position:relative}
...
.chat-header-info strong{display:block;color:var(--white);font-size:17px;font-weight:600;font-family:var(--font-display)}
.chat-header-info span{color:rgba(255,255,255,.78);font-size:14px}
.header-badge{background:rgba(255,255,255,.2);color:var(--white);font-size:13px;padding:3px 9px;border-radius:20px;border:1px solid rgba(255,255,255,.3);flex-shrink:0}
.sound-toggle{background:rgba(255,255,255,.2);border:1px solid rgba(255,255,255,.3);color:var(--white);font-size:17px;width:30px;height:30px;border-radius:50%;display:flex;align-items:center;justify-content:center;cursor:pointer;flex-shrink:0;transition:background .2s;line-height:1}
...
.bubble-avatar{width:26px;height:26px;border-radius:50%;background:linear-gradient(135deg,var(--rose-light),var(--rose));display:flex;align-items:center;justify-content:center;font-size:14px;flex-shrink:0}
...
.bubble{max-width:82%;padding:11px 15px;border-radius:18px;font-size:16px;line-height:1.55;word-break:break-word}
...
.bubble-time{font-size:12px;color:var(--warm-gray);margin-top:4px}
...
.pc-name{font-size:15px;font-weight:500;color:var(--dark);line-height:1.35;display:-webkit-box;-webkit-line-clamp:2;-webkit-box-orient:vertical;overflow:hidden}
.pc-price{font-size:16px;font-weight:600;color:var(--rose-dark);margin-top:3px}
.pc-why{font-size:13px;color:var(--warm-gray);margin-top:2px;line-height:1.3}
.pc-cta{display:inline-block;margin-top:4px;font-size:13px;color:var(--rose);font-weight:500}
/* Botones de enlace en mensajes (ej. estado de pedido) */
.msg-links{display:flex;flex-direction:column;gap:6px;margin-top:8px}
.msg-link-btn{display:inline-flex;align-items:center;justify-content:center;gap:6px;background:linear-gradient(135deg,var(--rose-dark),var(--rose));color:#fff!important;padding:9px 14px;border-radius:20px;font-size:15px;font-weight:600;text-decoration:none;transition:opacity .2s,transform .15s}
.msg-link-btn:hover{opacity:.9;transform:translateY(-1px)}
/* Quick replies */
.quick-replies{display:flex;flex-wrap:wrap;gap:7px;margin-top:2px}
.qr-btn{background:var(--white);border:1.5px solid var(--rose-light);color:var(--rose-dark);padding:6px 13px;border-radius:20px;font-size:14px;cursor:pointer;font-family:var(--font-body);font-weight:500;transition:background .18s,border-color .18s,transform .12s;white-space:nowrap}
...
.chat-input{flex:1;border:1.5px solid var(--sand);border-radius:24px;padding:10px 16px;font-size:16px;font-family:var(--font-body);color:var(--dark);background:var(--cream);outline:none;resize:none;max-height:96px;min-height:42px;line-height:1.5;transition:border-color .2s}
...
.attach-btn{width:42px;height:42px;border-radius:50%;background:var(--cream);border:1.5px solid var(--sand);cursor:pointer;display:flex;align-items:center;justify-content:center;flex-shrink:0;font-size:20px;color:var(--warm-gray);transition:background .15s,border-color .15s,color .15s}
...
.image-preview span{font-size:14px;color:var(--warm-gray)}
.image-preview button{margin-left:auto;background:none;border:none;color:var(--warm-gray);cursor:pointer;font-size:18px;padding:4px;line-height:1}
...
.powered-by{text-align:center;font-size:12px;color:var(--warm-gray);margin-top:8px;opacity:.7}
/* BOTÓN ANDREA */
.andrea-bar{
  padding:10px 16px;
...
.modal-box h3{font-family:var(--font-display);font-size:20px;color:var(--dark);margin-bottom:10px}
.modal-box p{font-size:15px;color:var(--warm-gray);line-height:1.6;margin-bottom:18px}
...
.gate-logo{text-align:center;font-size:37px;margin-bottom:4px}
.gate-logo img{width:56px;height:56px;border-radius:50%;object-fit:cover;display:inline-block}
.gate-title{font-family:var(--font-display);font-size:20px;color:var(--dark);text-align:center;line-height:1.4}
.gate-subtitle{font-size:15px;color:var(--warm-gray);text-align:center}
.email-field{border:1.5px solid var(--sand);border-radius:24px;padding:11px 18px;font-size:16px;font-family:var(--font-body);color:var(--dark);background:var(--cream);outline:none;transition:border-color .2s;text-align:center;width:100%}
.email-field:focus{border-color:var(--rose)}
.email-field::placeholder{color:var(--warm-gray)}
.email-submit{background:linear-gradient(135deg,var(--rose-dark),var(--rose));color:white;border:none;border-radius:24px;padding:11px;font-size:16px;font-weight:600;font-family:var(--font-body);cursor:pointer;transition:opacity .2s,transform .15s;width:100%}
.email-submit:hover{opacity:.9;transform:translateY(-1px)}
.email-error{font-size:14px;color:#dc2626;text-align:center;display:none}
/* Opciones cómo nos conociste */
.source-options{display:grid;grid-template-columns:1fr 1fr;gap:8px}
.source-btn{background:var(--white);border:1.5px solid var(--sand);border-radius:12px;padding:10px 8px;font-size:14px;font-family:var(--font-body);color:var(--dark);cursor:pointer;transition:all .18s;text-align:center;line-height:1.3}
...
.rating-icon{font-size:37px;margin-bottom:8px}
.rating-title{font-family:var(--font-display);font-size:18px;color:var(--dark);margin-bottom:6px;line-height:1.4}
.rating-subtitle{font-size:14px;color:var(--warm-gray);margin-bottom:16px}
.stars{display:flex;justify-content:center;gap:8px;margin-bottom:14px}
.star{font-size:37px;cursor:pointer;transition:transform .15s;filter:grayscale(1);opacity:.4}
.star:hover,.star.active{filter:grayscale(0);opacity:1;transform:scale(1.15)}
.rating-comment{width:100%;border:1.5px solid var(--sand);border-radius:10px;padding:10px 12px;font-size:15px;font-family:var(--font-body);color:var(--dark);background:var(--cream);outline:none;resize:none;transition:border-color .2s;margin-bottom:12px}
.rating-comment:focus{border-color:var(--rose)}
.rating-submit{width:100%;background:linear-gradient(135deg,var(--rose-dark),var(--rose));color:white;border:none;border-radius:10px;padding:10px;font-size:16px;font-weight:600;font-family:var(--font-body);cursor:pointer;transition:opacity .2s}
.rating-submit:hover{opacity:.9}
.rating-skip{background:none;border:none;color:var(--warm-gray);font-size:14px;cursor:pointer;margin-top:8px;font-family:var(--font-body);text-decoration:underline}
.rating-thanks{font-size:17px;color:var(--dark);padding:8px 0}
...
@media (max-width:480px){
  .dmat-fab{bottom:16px;right:16px;width:54px;height:54px;font-size:26px}
}
`;
...
function renderAndreaWaitOptions() {
  ...
  emailBtn.onclick = () => {
    ...
    renderBubble('agent', `¡Perfecto! Le aviso a Andrea para que te escriba a ${window._customerEmail} en cuanto esté disponible 💛 Si prefieres que te conteste por WhatsApp, dime tu número y se lo paso también 📱`)
  }
...
function renderClosingOptions() {
  ...
  emailBtn.onclick = () => {
    ...
    if (_inactivityTimer) { clearInterval(_inactivityTimer); _inactivityTimer = null }
    notifyAndreaContact('email')
    renderBubble('agent', `¡Perfecto! Andrea te escribirá a ${window._customerEmail} en cuanto esté disponible 💛 Si tienes más dudas, podemos seguir hablando aquí cuando quieras.`)
  }
...
function renderAndreaBubble(text) {
  ...
  row.innerHTML = `
    ...
    <div>
      <div style="font-size:12px;color:var(--warm-gray);margin-bottom:3px">Andrea</div>
...
MOTIVO: <resumen completo del problema, con todos los detalles que tengas, en una sola línea>
FECHA_ENTREGA: <fecha prevista de entrega, formato AAAA-MM-DD>
...
function renderBubble(role, content, imageDataUrl) {
  ...
  if (role === "agent") {
    ...
    if (cleanContent.includes('DATOS_INCIDENCIA')) {
      cleanContent = cleanContent.replace(/DATOS_INCIDENCIA[\s\S]*?FIN_DATOS_INCIDENCIA/, '').trim();
    }
    ...
    try {
      ...
      if (msgs && msgs.length > 0) {
        ...
        if (lastMsgs.length > 0) {
          ...
          divider.style.cssText = 'text-align:center;font-size:13px;color:var(--warm-gray);padding:8px 0;opacity:.7'
